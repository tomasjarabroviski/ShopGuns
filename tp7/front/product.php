			...
			<div class="row">
				<div class="col">
					<div class="viewed_title_container">
						<h3 class="viewed_title">Productos Similares</h3>
				...
				<div class="col">
					<div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
						<div class="newsletter_title_container">
							...
							<div class="newsletter_title">Registrate para noticias</div>
							<div class="newsletter_text"><p>...y recibe un cupon de 20% para tu primer envio.</p></div>
						</div>
						<div class="newsletter_content clearfix">
							<form action="#" class="newsletter_form">
								<input type="email" class="newsletter_input" required="required" placeholder="Ingrese una direccion de Email">
								<button class="newsletter_button">suscribete</button>
							</form>
							<div class="newsletter_unsubscribe_link"><a href="#">desusbribete</a></div>
						</div>
					</div>
				</div>
			</div>
