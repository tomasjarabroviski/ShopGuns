                            ...
                            <div class="card-body card-block">
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="NombreUsuario" name="text-input" placeholder="Nombre Usuario" class="form-control"><small class="form-text text-muted"></small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Apellido Usuario</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="ApellidoUsuario" name="text-input" placeholder="Apellido Usuario" class="form-control"><small class="form-text text-muted"></small></div>
                                    </div>
                                    <div class="row form-group">
